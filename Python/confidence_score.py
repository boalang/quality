            ...
            if line.find(":") != -1:
                ...
                if row_id in seq_cluster_Dict:
                    ...
                    try:
                        ...
                        sum = 0
                        w = 1  # w is a weighting factor; manual database more weight
                        top_taxa = 0

                        # check for manual vs computational
                        # if manual w = 2 else w =1
                        # add prov(taxa) function to check the provenance

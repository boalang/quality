...
'''
 input example:
    115L {'10665': 508, '348604': 11, '224324': 6, '2294': 1}
    118L {'10665': 508, '348604': 11, '224324': 6, '10101': 1}

 output: 
    find violation; print seq id and type of violation
'''

ncbi = NCBITaxa()

# uncomment this: local file for test
#input_file = "Log_conflicts_tmp_converted"
...
def tree_validation(key, taxDic):
    ...
    try:
        ...
        # check the kindom violation.
            ...
            print(key, "superkingdom violation")
